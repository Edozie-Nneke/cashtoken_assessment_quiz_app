        ...
        <section className='startpage-wrapper'>
          ...
          <div className='startpage-settings-wrapper'>
            <div className='random'>
              ...
              <ul>
                <li>
                  This a timed quiz. You have 10 minutes to complete 10
                  questions.
                </li>
                <li>
                ...
                <li>
                  Select from 3 different difficulty levels: Easy, Medium and
                  Hard
                </li>
                <li>
                ...
                <li>
                  ...
                  <b>
                    Please note that the quiz will be terminated when the timer
                    on the right of your screen runs down and your result
                    displayed!
                  </b>
                </li>
              </ul>
